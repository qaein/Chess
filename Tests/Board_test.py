...
def move_test():
    ...
    assert(b.move("e7","e5"))  # now it's bottom's turn
    # start cell: 8*6 gets a7, + 4 = e7 -- e7 is 52
    # end cell: 8*4 gets a5, + 4 = e5 -- e5 is 36
